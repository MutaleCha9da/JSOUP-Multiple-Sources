...
public class InvestmentForBeginnersActivity extends AppCompatActivity {
    ...
    String htmlPage = "<html>\n" +
            ...
            "\n" +
            "    <p>Purchase of shares through any of the registered and licensed Stockbrokers of your choice. These are professionals trained to give you the necessary information in order to make an informed decision. Click on link to see list of Stockbrokers\n" +
            "        <a href=\"http://www.luse.co.zm/brokerage_firms/\"></a>http://www.luse.co.zm/brokerage_firms/</p>\n" +
            "\n" +
            ...
            "    </ul>\n" +
            "    <p>For more information, kindly refer to the Brokerage Firms Page and/ or email us at <a href=\"#\">info@luse.co.zm/ phil@luse.co.zm/ kennedy@luse.co.zm</a></p>\n" +
            "</body>\n" +
            "\n" +
            "</html>";
